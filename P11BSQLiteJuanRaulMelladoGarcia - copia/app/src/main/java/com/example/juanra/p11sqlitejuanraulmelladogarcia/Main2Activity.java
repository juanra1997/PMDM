        ...
        if(fila.moveToFirst()){
            ...
            while(c<n) {
                ...
                if(c!=0){
                    ...
                    texto.setText(texto.getText()+"Producto "+String.valueOf(c+1)+"\n\fCodigo: "+fila.getString(0)+"\n\fdescripcion: "+fila.getString(1)+"\n\fprecio: "+fila.getString(2)+"\n\fcolor: "+fila.getString(3));
                    //texto.setText(texto.getText()+fila.getString(0) + "\f" + fila.getString(1) + "\f" + fila.getString(2) + "\f" + fila.getString(3) + "\n");
                    fila.moveToNext();
                    c++;
                /*} catch (Exception e) {
            ...
            texto.setText("No existen articulos");
        }
