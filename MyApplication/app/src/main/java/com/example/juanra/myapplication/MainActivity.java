...
public class MainActivity extends AppCompatActivity {
    ...
    public void registrar(View view){
        ...
        ObjetoEditor.putString("usuario"+usuario.getText().toString(), usuario.getText().toString());
        ObjetoEditor.putString("contra"+usuario.getText().toString(), contra.getText().toString());
    ...
    public void siguienteActivity(View view){
        ...
        miContra=preferences.getString("contra"+usuario.getText().toString(), "");
        miUser=preferences.getString("usuario"+usuario.getText().toString(), "");
