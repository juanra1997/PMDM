...
public class IntroducirActivity extends AppCompatActivity {
    ...
    DatabaseReference cont, contrasenna, pregr;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cont = database.getReference(group).child("cont");
        pregr = database.getReference(group);
        contrasenna = database.getReference(group).child("contra");
        ...
        //DatabaseReference contrasenna = database.getReference(group).child("contra");
        ...
        contrasenna.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                /*}catch (Exception e){
                    DatabaseReference inc = database.getReference(group);

                    inc.child("contra").setValue(pass);
    ...
    public void guardarPreguntas(View v) {
        ...
        if (pregunta.getText().toString().isEmpty() || autor.getText().toString().isEmpty() || r1.getText().toString().isEmpty() || r2.getText().toString().isEmpty() || r3.getText().toString().isEmpty() || r4.getText().toString().isEmpty()) {
            ...
            contrasenna.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    /*}catch (Exception e){
                        ...
                        DatabaseReference inc = bd.getReference(group);
            ...
            //DatabaseReference preg = database.getReference(group);

            //Guardamos la pregunta

            if(contra==null||contra.equals(pass)) {

                pregr.child("Preguntas").child("Pregunta" + mivalor).setValue(preg);

                //Cambiamos la cantidad de preguntas de la base de datos

                cont.setValue(mivalor);
                if(contra==null){
                    contrasenna.setValue(pass);
                }
            }
